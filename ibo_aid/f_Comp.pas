...
type
  TFrmFndComp = class(TcrDlgForm)
    ...
    TabView: TTabSheet;
    GrdBrw: TcrdbGrid;
    QryCompCOUNTRYNAME: TStringField;
    ...
    Btns: TcrBtnPanel;
    QryCompCOMPTYPE: TStringField;
    QryCompLOCADDRESS: TStringField;
    QryCompLOCNOTE: TMemoField;
    QryCompTELPRE: TStringField;
    QryCompTELNO: TStringField;
    QryCompFAXPRE: TStringField;
    QryCompFAXNO: TStringField;
    QryCompTELEX: TStringField;
    QryCompEMAIL: TStringField;
    QryCompWWW: TStringField;
...
function Execute(ADatabase: TIB_connection; var ACompDef: TvalCompDef): Boolean; Overload;
function Execute(ADatabase: TIB_connection; var ACompDef: TvalCompDef; AIsSupplier, AIsTransporter, AIsCustomer,
...
function Execute(ADatabase: TIB_connection; var ACompDef: TvalCompDef) : Boolean;
begin
  XrCompDef := ACompDef;
...
begin
  ibTran.Rollback;// Active:= False;
  ibTran.IB_Connection:= XuDatabase;
  ibTran.StartTransaction;
  //
  QryCompType.IB_Connection:= XuDatabase;
  QryCompType.IB_Transaction := ibTran;
  QryCountry .IB_Connection:= XuDatabase;
  QryCountry .IB_Transaction := ibTran;
  //
  LoadCompTypes;
  LoadUserInfo;
  //
  ...
  //
  QryComp.IB_Connection   := XuDatabase;
  QryComp.IB_Transaction  := ibTran;
  //
