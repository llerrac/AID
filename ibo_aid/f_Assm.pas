...
uses
  ...
  aiddbLkpAssm,
  crdbUtil, IB_Components, IBODataset, crIBQry;
...
type
  TFrmFndAssm = class(TcrDlgForm)
    ...
    QryITEMDESC: TStringField;
    QryVISIBILITY: TStringField;
    QryMODEL: TStringField;
    QryENGINEER: TStringField;
    QrySTATUS: TStringField;
    QryISSUENO: TIntegerField;
    QryITEMMEMO: TMemoField;
    QryCREATEDDTE: TDateTimeField;
    QryCREATEDBY: TStringField;
    QryALTEREDDTE: TDateTimeField;
    QryALTEREDBY: TStringField;
...
function Execute(ADatabase: TIB_Connection; var AAssmDef: TvalAssmDef): Boolean;
