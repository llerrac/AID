...
{ -------------------------------------------------------------------------------------------------
  ...
  Modified    :
   ...
   2010 jan ajc added restricted country to company drop down
  -------------------------------------------------------------------------------------------------}
interface

uses
  IB_Components,IBODataset, aidTypes;
...
function GetPurchInfo    (AuIBDatabase: TIB_connection; AsTranNo: string; var rPurchDef: TvalPurchDef): Boolean;
function GetPurchPartInfo(AuIBDatabase: TIB_connection; AsTranNo, AsPartNo, AsParam: string; var rPurchItemDef: TvalPurchItemDef): Boolean;

(*  GetCompanyInfo
      Returns information re. company AsCompNo - refer to GetPurchInfo documentation *)
function GetCompanyInfo(AuIBDatabase: TIB_connection; AsCompNo: string; var rCompDef : TvalCompDef ): Boolean;

(*  GetContractInfo
      Returns information re. company AsCompNo - refer to GetPurchInfo documentation *)
function GetContractInfo(AuIBDatabase: TIB_connection; AsContNo: string; var rContDef : TvalContDef ): Boolean;
...
(*  GetPartInfo
      ...
      see the PROC_Part_GetInfo stored proc, as this documents the Weighting methodology, & which fields are mandatory
          ...
          AnWeighting   = bias
          APartDef      = result *)
function GetPartInfo(const AuIBDatabase: TIB_connection; const AsPartNo, AsPartParam, AsPartOp, AsPrefSite, AsPrefSupp: string; AnWeighting: Integer; var rPartDef: TaidPartDef): Boolean;
...
function GetPartParametersToString(AuIBDatabase: TIB_connection; AsPartNo: string; var sPartParams: string): Boolean;

(*  GetPartOperationsToString
      Returns the available operations for Part AsPartNo (Using QryPtParam) into a delimited sPartOps *)
function GetPartOperationsToString(AuIBDatabase: TIB_connection; AsPartNo: string; var sPartOps: string): Boolean;

(*  GetCountryInfo
      Returns the country information for Country AsCountry *)
function GetCountryInfo(AuIBDatabase: TIB_connection; AsCountryNo: String; var rCountry: TvalCountry): Boolean;
...
begin
  ...
  begin
    ...
    begin
      QryPurch.Close;
      QryPurch.IB_Connection:= AuIBDatabase;
...
begin
  ...
  begin
    ...
    begin
      QryPoCost.Close;
      QryPoCost.IB_connection:= AuIBDatabase;
...
begin
  ...
  begin
    ...
    begin
      QryComp.Close;
      QryComp.IB_connection:= AuIBDatabase;
...
begin
  ...
  begin
    ...
    begin
      QryCont.Close;
      QryCont.IB_connection:= AuIBDatabase;
...
begin
  ...
  begin
    ...
    begin
      QryPart.Close;
      QryPart.IB_connection:= AuIBDatabase;
...
begin
  ...
  begin
    ...
    begin
      QryCountry.Close;
      QryCountry.IB_connection:= AuIBDatabase;
...
begin
  ...
  begin
    ...
    begin
      QryPtParam.Close;
      QryPtParam.IB_connection:= AuIBDatabase;
...
begin
  ...
  begin
    ...
    begin
      QryPtOp.Close;
      QryPtOp.IB_connection:= AuIBDatabase;
