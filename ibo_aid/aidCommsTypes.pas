...
type
  ...
  public
    ...
    function  AnEmailExistsOutsideDomain(AsDomain: string): Boolean;
...
begin
  ...
  begin
    ...
    repeat
      ...
      //    Stanbridge John <John.Stanbridge@bobstgroup.com>
      //    Andrew.Monteith@bobstgroup.com,	neil.tompkins@bobstgroup.com,	cgr@roylesoft.co.uk
      if (iAt>0) then
      begin
...
function TEmailStringList.AnEmailExistsOutsideDomain(AsDomain: string): Boolean;
var
  sEmail  : string;
  iK      : integer;
begin
