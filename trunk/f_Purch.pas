...
uses
  ...
  aiddbLkpPurch,
  crdbUtil, IBCustomDataSet, IBDatabase, IBQuery, crIBQry, crInfo,
...
type
  TFrmFndPurchase = class(TcrDlgForm)
    ...
    GrdBrw: TcrdbGrid;
    Tmr: TTimer;
    QryTrSUPPNO: TIBStringField;
    QryTrSUPPNAME: TIBStringField;
    QryTrTRANSITE: TIBStringField;
    QryTrTRANNO: TIBStringField;
    QryTrTRANREF: TIBStringField;
    QryTrSUPPREF: TIBStringField;
    QryTrTRANDTE: TDateTimeField;
    QryTrTRANUSER: TIBStringField;
    QryTrTRANSTATUS: TIBStringField;
    QryTrDELIVERYSITE: TIBStringField;
    QryTrDELIVERYWARE: TIBStringField;
    QryTrEXPECTED: TDateTimeField;
    QryTrTRANUSERDESC: TIBStringField;
    QryTrTRANSTATUSDESC: TIBStringField;
    ...
    MemSrchDeliverySite: TIBStringField;
    ...
    QryTrISCOMPLETED: TIBStringField;
    Dlg: TcrDlgList;
...
function Execute(ADatabase: TIBDatabase; var APurchDef: TvalPurchDef; ALkpUser, ALkpStatus: TDataSet): Boolean;
...
begin
  aiddbUtil . GetCompanyInfo(QryTr.Database, Sender.AsString, rCompDef);
