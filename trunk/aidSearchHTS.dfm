object frmSearchHTS: TfrmSearchHTS
  ...
  object qryTariff: TcrIBQuery
    ...
    object qryTariffTARIFFNO: TIBStringField
    ...
    object qryTariffTARIFFCODING: TIBStringField
      DisplayLabel = 'Format'
    ...
    object qryTariffTARIFFDESC: TIBStringField
    ...
    object qryTariffTARIFFDESCUPPER: TIBStringField
  ...
  object mlkFilter01: TkbmMemTable
    ...
    Left = 20
    Top = 280
    object mlkFilter01FILTERKEY: TIBStringField
      DisplayLabel = 'Code'
      DisplayWidth = 10
      FieldName = 'FILTERKEY'
    ...
    object mlkFilter01FILTERDESC: TIBStringField
      DisplayLabel = 'Desc'
      FieldName = 'FILTERDESC'
      Origin = 'LOOKUPFILTER.FILTERDESC'
      Size = 255
    end
    object mlkFilter01FILTERWHERE: TIBStringField
  ...
  object mlkFilter02: TkbmMemTable
    ...
    Left = 20
    Top = 325
    object mlkFilter02FILTERKEY: TIBStringField
      DisplayLabel = 'Code'
      DisplayWidth = 10
      FieldName = 'FILTERKEY'
      Origin = 'LOOKUPFILTER.FILTERKEY'
    ...
    object mlkFilter02FILTERDESC: TIBStringField
      DisplayLabel = 'Desc'
      FieldName = 'FILTERDESC'
      Origin = 'LOOKUPFILTER.FILTERDESC'
      Size = 255
    end
    object mlkFilter02FILTERWHERE: TIBStringField
      FieldName = 'FILTERWHERE'
      Origin = 'LOOKUPFILTER.FILTERWHERE'
      Required = True
      Visible = False
  ...
  object mlkFilter03: TkbmMemTable
    ...
    Left = 20
    Top = 370
    object mlkFilter03FILTERKEY: TIBStringField
      DisplayLabel = 'Code'
      DisplayWidth = 10
      FieldName = 'FILTERKEY'
      Origin = 'LOOKUPFILTER.FILTERKEY'
    ...
    object mlkFilter03FILTERDESC: TIBStringField
      DisplayLabel = 'Desc'
      FieldName = 'FILTERDESC'
      Origin = 'LOOKUPFILTER.FILTERDESC'
      Size = 255
    end
    object mlkFilter03FILTERWHERE: TIBStringField
      FieldName = 'FILTERWHERE'
      Origin = 'LOOKUPFILTER.FILTERWHERE'
      Required = True
      Visible = False
  ...
  object qryFilter: TcrIBQuery
    ...
    object qryFilterFILTERKEY: TIBStringField
      FieldName = 'FILTERKEY'
      Origin = 'LOOKUPFILTER.FILTERKEY'
      Required = True
      Size = 15
    end
    object qryFilterFILTERDESC: TIBStringField
      FieldName = 'FILTERDESC'
      Origin = 'LOOKUPFILTER.FILTERDESC'
      Size = 255
    end
    object qryFilterFILTERWHERE: TIBStringField
      FieldName = 'FILTERWHERE'
      Origin = 'LOOKUPFILTER.FILTERWHERE'
      Required = True
      Size = 15
    end
    object qryFilterPARENTSECTION: TIBStringField
      FieldName = 'PARENTSECTION'
      Origin = 'LOOKUPFILTER.PARENTSECTION'
      FixedChar = True
      Size = 10
    end
    object qryFilterPARENTKEY: TIBStringField
      FieldName = 'PARENTKEY'
