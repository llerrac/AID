...
initialization
  ...
  begin
    ...
    AddObject('BROWN' , TaidwlWireFunctionObj.Create(
      WireFunction('BROWN' , 'BROWN - Power'   , $003167 , clNone  , clWhite ,''   , 'Brown')));
    AddObject('VIOLET' , TaidwlWireFunctionObj.Create(
      WireFunction('VIOLET' , 'VIOLET - Power'   , $fb8db5 , clNone  , clWhite ,''   , 'Violet')));
  end;
  // Cable Types
