object FrmFndAssm: TFrmFndAssm
  ...
  object Qry: TcrIBQuery
    ...
    object QryITEMDESC: TStringField
      DisplayLabel = 'Assembly'
      DisplayWidth = 40
      FieldName = 'ITEMDESC'
      Size = 50
    end
    object QryVISIBILITY: TStringField
      Alignment = taCenter
      DisplayLabel = 'Vis'
      DisplayWidth = 3
    ...
    object QryMODEL: TStringField
      DisplayLabel = 'Model'
      FieldName = 'MODEL'
      Size = 10
    end
    object QryENGINEER: TStringField
    ...
    object QryCREATEDBY: TStringField
      FieldName = 'CREATEDBY'
      Visible = False
      Size = 15
    end
    ...
    object QryALTEREDBY: TStringField
      FieldName = 'ALTEREDBY'
      Visible = False
      Size = 15
    end
