...
type
  TFrmFndBOM = class(TcrDlgForm)
    ...
    qryBOMISOBSOLETE: TStringField;
    qryBOMHASOPTIONS: TStringField;
    ...
    qryBOMMODELLITE: TStringField;
    qryBOMKEY_ENGLITE: TStringField;
    qryBOMBOMAKA1: TStringField;
    qryBOMCHECKOUTSTATE: TStringField;
    qryBOMCHECKEDOUTBY: TStringField;
    qryBOMCHECKEDOUTAT: TDateTimeField;
    qryBOMCHECKOUTREASON: TStringField;
    imgVCS: TImageList;
    qryBOMCHECKEDOUTBYNAME: TStringField;
...
function Execute(ADatabase: tib_connection; var ArBOMDef: TaidBOMDef): Boolean;
...
begin
  ...
  //
  QryBOM.IB_Connection:= XuDatabase;
  //
