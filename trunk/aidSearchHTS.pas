...
uses
  ...
  Grids, DBGrids, crdbGrid, crBtns, DB, IBCustomDataSet, IBQuery, crIBQry,
  IBDatabase, kbmMemTable, Mask, ComCtrls, crPage, crCtrls, crInfo,
  crdbInfo, crdbUtil, JvExDBGrids, JvDBGrid;
...
type
  TfrmSearchHTS = class(TcrDlgForm)
    ...
    tran: TIBTransaction;
    qryTariffTARIFFNO: TIBStringField;
    qryTariffTARIFFCODING: TIBStringField;
    qryTariffTARIFFDESC: TIBStringField;
    ...
    qryFilterFILTERKEY: TIBStringField;
    qryFilterFILTERDESC: TIBStringField;
    qryFilterFILTERWHERE: TIBStringField;
    ...
    mlkFilter01FILTERKEY: TIBStringField;
    mlkFilter01FILTERDESC: TIBStringField;
    mlkFilter01FILTERWHERE: TIBStringField;
    mlkFilter02FILTERKEY: TIBStringField;
    mlkFilter02FILTERDESC: TIBStringField;
    mlkFilter02FILTERWHERE: TIBStringField;
    mlkFilter03FILTERKEY: TIBStringField;
    mlkFilter03FILTERDESC: TIBStringField;
    mlkFilter03FILTERWHERE: TIBStringField;
    qryTariffTARIFFDESCUPPER: TIBStringField;
    pge: TcrPageControl;
    tabBrw: TTabSheet;
    tabView: TTabSheet;
    grdHTS: TcrdbGrid;
    ...
    srcHSC: TDataSource;
    qryFilterPARENTSECTION: TIBStringField;
    qryFilterPARENTKEY: TIBStringField;
  ...
  public
     { Public declarations }
    constructor CreateEx(Adb: TIBDatabase; AsTariffCoding, AsTariffCode: string);
  end;

function Execute(Adb: TIBDatabase; var sTariffCoding, sTariffCode: string): Boolean;
...
constructor TfrmSearchHTS.CreateEx(Adb: TIBDatabase; AsTariffCoding, AsTariffCode: string);
begin
